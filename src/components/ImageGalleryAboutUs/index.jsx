...
// components/ImageGalleryAboutUs.js
            ...
            {Object.entries(sections).map(([key, sec], sectionIdx) => {
                ...
                return (
                    <div key={key} className="mb-16">
                        ...
                        <div
                            className="grid grid-cols-1 sm:grid-cols-2  place-items-center md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8 max-w-[1700px] mx-auto">
