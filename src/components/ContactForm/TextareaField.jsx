...
export default memo(function TextareaField({ label, error, ...textareaProps }) {
  const hasError = Boolean(error);
  const baseCls =
    "peer w-full border rounded-lg px-4 pt-5 pb-2 h-32 resize-none text-sm transition duration-200 bg-white dark:bg-slate-800 placeholder-transparent focus:outline-none focus:ring-2";
